...
(defvar solarized-colors           ; ANSI(Solarized terminal)
  ...
  '((base03  "#000000" "#042028" "#1c1c1c" "brightblack"   "black") ;;change from #002b36 - modified: #000000
    (base02  "#073642" "#0a2832" "#262626" "black"         "black") ;;change from #073642
    (base01  "#586e75" "#465a61" "#585858" "brightgreen"   "green") ;;change from #586e75 - sRGB - modified: #eef0f1
    ...
    (red     "#dc322f" "#c60007" "#d70000" "red"           "red")  ;;sRGB changed from #dc322f - modified: #ff0400
